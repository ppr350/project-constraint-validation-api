...
function showEmailError() {
  ...
  if (
    ...
    emailError.textContent =
      "Email address should be between 3 to 64 characters long.";
  }
...
function showConfirmPasswordError() {
  ...
  if (
    ...
    confirmPassword.validity.tooLong
  ) {
    confirmPasswordError.textContent =
      "Password should be minimum 8 charaters long.";
  }
